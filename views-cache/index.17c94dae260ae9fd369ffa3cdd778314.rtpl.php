                    ...
                    <div class="latest-product">
                        ...
                        <div class="product-carousel">
                            <div class="single-product">
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        <a href="carrinho.html" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Reservar</a>
                                        <a href="detalhes-produto.html" class="view-details-link"><i class="fa fa-link"></i> Ver detalhes</a>
                                    </div>
                                </div>
                                
                                <h2><a href="lista-produtos.html">Soja</a></h2>
                                
                                <div class="product-carousel-price">
                                    <ins>$109,05</ins> <del>$124,05</del>
                                </div> 
                            </div>
                            <div class="single-product">
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Reservar</a>
                            ...
                            <div class="single-product">
                                ...
                                <h2><a href="#">Feijão </a></h2>

                                <div class="product-carousel-price">
                                    <ins>$197.00</ins> <del>$220.00</del>
                                </div>                            
                            </div>
                            <div class="single-product">
                                <div class="product-f-image">
                            ...
                            <div class="single-product">
                                ...
                                <h2><a href="#">Aveia</a></h2>

                                <div class="product-carousel-price">
                                    <ins>$36.50</ins><del>$39.00</del>
                                </div>                            
                            </div>
                        </div>
                    </div>
